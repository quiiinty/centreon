...
class ServiceGroupResourceRequestProvider extends AbstractRepositoryRDB implements NotificationResourceRequestProviderInterface
{
    ...
    public function findByIds(array $resourceIds): array
    {
        ...
        // return $notification;
        return [new NotificationGenericResource(1, 'ResourceSGTestName')];
    }
}
